...
$('#header').siblings('div').css({'border': 'double', 'padding': '20px'})
...
// in #list-3
  ...
  $('#list-3 li:first').css({'color': 'aqua'})
...
$('img').eq(0).parent().css({'float': 'left', 'border': '1px solid red'})
